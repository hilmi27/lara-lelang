        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{{route('admin.jenisikan.edit', [$data->id])}}" class="btn btn-info btn-sm">Edit</a>                
            
              <form class="d-inline" action="{{route('admin.jenisikan.destroy', [$data->id])}}" method="POST" onsubmit="return confirm('Apakah kamu yakin ?')">

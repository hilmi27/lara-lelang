    ...
    <div class="card-body">
      ...
      <div class="col-md-6 form-group">
        ...
        <select name="jenis_ikan" id="" class="form-control  {{$errors->first('jenis_ikan') ? "is-invalid" : ""}}">
            ...
            <option value="{{$jenis->name}}" {{$jenis->name == $ikan->jenis_ikan ? "selected":""}}  >{{$jenis->name}}</option>
      ...
      <div class="col-md-6 form-group">
        ...
        <select name="kualitas" id="" class="form-control  {{$errors->first('kualitas') ? "is-invalid" : ""}}">
            ...
            <option {{$ikan->kualitas == 'A' ? 'selected' : ''}} value="A">A</option>

            <option {{$ikan->kualitas == 'B' ? 'selected' : ''}} value="B">B</option>

            <option {{$ikan->kualitas == 'C' ? 'selected' : ''}} value="C">C</option>

            <option {{$ikan->kualitas == 'BS' ? 'selected' : ''}} value="BS">BS</option>
      ...
      <div class="col-md-6 form-group">
        ...
        <input type="number" name="ukuran" value="{{old('ukuran') ? old('ukuran') : $ikan->ukuran}}" class="form-control  {{$errors->first('ukuran') ? "is-invalid" : ""}}"  id="ukuran" placeholder="Masukkan ukuran ikan">
      ...
      <div class="col-md-6 form-group">
        ...
        <input type="number" name="qty"  value="{{old('qty') ? old('qty') : $ikan->qty}}" class="form-control  {{$errors->first('qty') ? "is-invalid" : ""}}"  id="qty" placeholder="1000">
      ...
      <div class="col-md-6 form-group">
        ...
        <input type="number" name="harga"  value="{{old('harga') ? old('harga') : $ikan->harga}}" class="form-control  {{$errors->first('harga') ? "is-invalid" : ""}}"  id="harga" placeholder="20000">
      ...
      <div class="col-md-6 form-group">
        ...
        <input type="date" name="tgl_masuk"  value="{{old('tgl_masuk') ? old('tgl_masuk') : $ikan->tgl_masuk}}" class="form-control  {{$errors->first('tgl_masuk') ? "is-invalid" : ""}}" id="tgl_masuk">
      ...
      <div class="col-md-6 form-group">
        ...
        <select name="wilayah_penangkapan" id="" class="form-control  {{$errors->first('wilayah_penangkapan') ? "is-invalid" : ""}}">
            ...
            <option value="{{$wilayah->nama}}" {{$wilayah->nama == $ikan->wilayah_penangkapan ? "selected":""}} >{{$wilayah->nama}}</option>
